			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group{{ $errors->has('code') ? ' is-invalid' : '' }}">
						...
						<input type="text" class="form-control" id="field-code" name="code" value="{{ old('code') }}">
				...
				<div class="col-md-6">
					<div class="form-group{{ $errors->has('nominal') ? ' is-invalid' : '' }}">
						...
						<input type="text" class="form-control" id="field-nominal" name="nominal" value="{{ old('nominal') }}">
				...
				<div class="col-md-12">
					<div class="form-group{{ $errors->has('note') ? ' is-invalid' : '' }}">
						...
						<input type="text" class="form-control" id="field-note" name="note" value="{{ old('note') }}">
