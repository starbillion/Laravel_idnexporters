...
@section('title', __('general.products') . ' - '. __('general.add'))

@section('content')
<nav class="breadcrumb bg-white push">
    <a class="breadcrumb-item" href="{{ route('member.product.post.index') }}">{{ __('general.my_products') }}</a>
    <span class="breadcrumb-item active text-muted">{{ __('general.add') }}</span>
</nav>

<div class="block block-bordered">
    <form action="{{ route('member.product.post.store') }}" method="post">
        {{ csrf_field() }}
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group{{ $errors->has('price') ? ' is-invalid' : '' }}">
                        ...
                        <input type="text" class="form-control" id="field-price" name="price" value="{{ old('price') }}">
                ...
                <div class="col-md-3">
                    <div class="form-group{{ $errors->has('supply_ability') ? ' is-invalid' : '' }}">
                        ...
                        <input type="text" class="form-control" id="field-supply_ability" name="supply_ability" value="{{ old('supply_ability') }}">
                ...
                <div class="col-md-3">
                    <div class="form-group{{ $errors->has('fob_port') ? ' is-invalid' : '' }}">
                        ...
                        <input type="text" class="form-control" id="field-fob_port" name="fob_port" value="{{ old('fob_port') }}">
                ...
                <div class="col-md-3">
                    <div class="form-group{{ $errors->has('payment_term') ? ' is-invalid' : '' }}">
                        ...
                        <input type="text" class="form-control" id="field-payment_term" name="payment_term" value="{{ old('payment_term') }}" placeholder="{{ __('product/post.payment_term_placeholder') }}">
                ...
                <div class="col-md-3">
                    <div class="form-group{{ $errors->has('minimum_order') ? ' is-invalid' : '' }}">
                        ...
                        <input type="text" class="form-control" id="field-minimum_order" name="minimum_order" value="{{ old('minimum_order') }}">
                ...
                <div class="col-md-12">
                    <div class="form-group{{ $errors->has('description_en') ? ' is-invalid' : '' }}">
                        ...
                        <textarea class="form-control field_description" name="description_en" rows="6">{{ old('description_en') }}</textarea>
                ...
                <div class="col-md-12">
                    <div class="form-group{{ $errors->has('description_id') ? ' is-invalid' : '' }}">
                        ...
                        <textarea class="form-control field_description" name="description_id" rows="6">{{ old('description_id') }}</textarea>
                ...
                <div class="col-md-12">
                    <div class="form-group{{ $errors->has('description_zh') ? ' is-invalid' : '' }}">
                        ...
                        <textarea class="form-control field_description" name="description_zh" rows="6">{{ old('description_zh') }}</textarea>
