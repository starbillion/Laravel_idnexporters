...
<div class="block block-bordered">
                ...
                <div class="row justify-content-md-center">
                    <div class="col-md-3">
                        <div class="options-container">
                            ...
                            <img id="company_logo" class="img-thumbnail options-item" src="{{ asset($product->getFirstMediaUrl('product', 'thumb')) }}" alt="">
                            <div class="options-overlay bg-black-op-75">
                                <div class="options-overlay-content p-20">
                                    <a class="btn btn-sm btn-block btn-alt-secondary min-width-75" onclick="event.preventDefault(); document.getElementById('upload-product').click()">
                                        {{ __('general.change_image') }}
                                    </a>
                                    ...
                                    <form id="form-delete" method="post" action="{{ route('member.product.post.media.destroy', $product->id) }}" class="d-none">
                                        {{ csrf_field() }}
                            ...
                            <form id="form-upload" method="post" action="{{ route('member.product.post.media.upload', $product->id) }}" class="d-none" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <input id="upload-product" type="file" name="product" onchange="event.preventDefault(); Codebase.loader('show'); document.getElementById('form-upload').submit();" />
                            </form>
    ...
    <form action="{{ route('member.product.post.update', $product->id) }}" method="post">
        {{ csrf_field() }}
